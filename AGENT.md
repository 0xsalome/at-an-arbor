...
- Commit locally as needed; push only after the user confirms.
- If `git push` fails, report the error to the user and stop. Never retry with `--force`, and never change git or sandbox configuration to work around a failure.
